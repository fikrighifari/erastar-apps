...
//         // dataAsset:
//         //     json["data"] == null ? null : DataAsset.fromMap(json["data"]),
//       );

//   Map<String, dynamic> toMap() => {
//         "status": status,
//         "message": message,
//         // "data": dataAsset?.toMap(),
//       };
// }
...
//   int? totalPage;
//   int? totalData;
//   List<ListDataAsset>? dataListAsset;
...
//         "data": dataListAsset == null
//             ? []
//             : List<dynamic>.from(dataListAsset!.map((x) => x.toMap())),
//       };
// }
  ...
  factory DataAsset.fromMap(Map<String, dynamic> json) => DataAsset(
        ...
        data: json["data"] == null
            ...
            : List<DataListAsset>.from(
                json["data"]!.map((x) => DataListAsset.fromMap(x))),
      );
...
class DataListAsset {
  ...
  factory DataListAsset.fromJson(String str) =>
      DataListAsset.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory DataListAsset.fromMap(Map<String, dynamic> json) => DataListAsset(
        id: json["_id"],
        listingId: json["listing_id"],
        user: json["user"] == null ? null : User.fromMap(json["user"]),
        office: json["office"] == null ? null : Office.fromMap(json["office"]),
