...
class DataInvoice {
  DataInvoice({
    ...
    required this.dataListInvoice,
  });

  final int? page;
  final int? totalPage;
  final int? totalData;
  final List<DataListInvoice> dataListInvoice;
  ...
  factory DataInvoice.fromJson(Map<String, dynamic> json) {
    return DataInvoice(
      ...
      dataListInvoice: json["data"] == null
          ? []
          : List<DataListInvoice>.from(
              json["data"]!.map((x) => DataListInvoice.fromJson(x))),
    );
  }
}

class DataListInvoice {
  DataListInvoice({
    required this.id,
    required this.asset,
  ...
  factory DataListInvoice.fromJson(Map<String, dynamic> json) {
  ...
  factory Asset.fromJson(Map<String, dynamic> json) {
    return Asset(
      ...
      sertifikat: json["sertifikat"] == null
          ? []
          : List<Image>.from(json["sertifikat"]!.map((x) => Image.fromJson(x))),
      type: json["type"],
      status: json["status"] == null ? null : Status.fromJson(json["status"]),
...
class Auction {
  Auction({
    ...
    required this.createdAt,
    required this.v,
    required this.pengumumanLelangPath,
    required this.updatedAt,
  });
  ...
  final DateTime? createdAt;
  final int? v;
  final String? pengumumanLelangPath;
  final DateTime? updatedAt;
  ...
  factory Auction.fromJson(Map<String, dynamic> json) {
    return Auction(
      ...
      createdAt: DateTime.tryParse(json["created_at"] ?? ""),
      v: json["__v"],
      pengumumanLelangPath: json["pengumuman_lelang_path"],
      updatedAt: DateTime.tryParse(json["updated_at"] ?? ""),
    );
  }
}
